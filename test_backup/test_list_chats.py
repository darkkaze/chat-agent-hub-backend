...
async def test_list_chats_ordered_by_last_message_ts(session):
    ...
    assert result.chats[0].name == "Chat Newest"
    assert result.chats[1].name == "Chat Recent"
    assert result.chats[2].name == "Chat Old"
