...
async def test_delete_agent_soft_delete_success(session):
    ...
    target_agent = Agent(
        name="Target Bot",
        webhook_url="https://target.bot/hook",
...
async def test_delete_agent_hard_delete_success(session):
    ...
    # Note: Channel association removed per model changes
    ...
    # Note: Channel associations removed per model changes
...
async def test_delete_agent_member_forbidden(session):
    ...
    agent = Agent(
        name="Protected Bot",
        webhook_url="https://protected.bot/hook"
    )
...
async def test_delete_agent_hard_delete_multiple_associations(session):
    ...
    agent = Agent(
        ...
        webhook_url="https://multi.bot/hook"
    )
