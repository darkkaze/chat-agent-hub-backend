...
async def test_receive_whatsapp_text_message_success(session):
    ...
    # And create a chat with updated last message info
    ...
    assert created_chat.last_sender_type == SenderType.CONTACT
    assert created_chat.last_message == "Hello, this is a test message!"
